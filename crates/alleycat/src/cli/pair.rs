...
pub struct PairArgs {
    ...
    #[arg(
        long = "runtime",
        value_name = "ID",
        required_unless_present = "legacy",
    ...
    #[arg(long, conflicts_with_all = ["legacy", "unattended"])]
    ...
    #[arg(
        long,
        conflicts_with_all = ["legacy", "allow_restart"],
    ...
    #[arg(long, requires = "unattended", conflicts_with = "legacy")]
